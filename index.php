...
<script>
    const weatherData = [
        { temp: '22 °C', city: 'New York', humidity: '50%', wind: '15 km/h' },
        { temp: '24 °C', city: 'Los Angeles', humidity: '60%', wind: '10 km/h' },
        { temp: '18 °C', city: 'Chicago', humidity: '55%', wind: '20 km/h' },
        { temp: '25 °C', city: 'Houston', humidity: '70%', wind: '5 km/h' },
        { temp: '20 °C', city: 'Phoenix', humidity: '30%', wind: '10 km/h' },
        { temp: '23 °C', city: 'Philadelphia', humidity: '65%', wind: '12 km/h' },
        { temp: '19 °C', city: 'San Antonio', humidity: '45%', wind: '8 km/h' }
    ];
    ...
    weatherData.forEach(day => {
        ...
        weatherDiv.innerHTML = `
            <img src="img/images/rain.png" class="weather-icon" alt="Weather Icon">
